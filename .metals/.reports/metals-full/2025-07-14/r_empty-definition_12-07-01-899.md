error id: file:///C:/CodeMine/dataprocess%20mine/backend/app/models/DetectionColonne.scala:`<none>`.
file:///C:/CodeMine/dataprocess%20mine/backend/app/models/DetectionColonne.scala
...
offset: 470
uri: file:///C:/CodeMine/dataprocess%20mine/backend/app/models/DetectionColonne.scala
text:
```scala
package models
...
object DetectionColonne {
  ...
  sealed trait DataType {
    def name: String
    def priority: Int // Pl@@us le nombre est élevé, plus le type est spécifique
  }
